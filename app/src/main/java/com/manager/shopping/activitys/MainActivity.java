...
import com.manager.shopping.fragments.BaketFragment;
...
import com.manager.shopping.fragments.ShopFragment;

public class MainActivity extends FragmentActivity implements OnClickListener {
    private LinearLayout tv_cate, tv_find, tv_barket, tv_person;
    FragmentManager manager;
    FragmentTransaction transaction;
    //	CateFragment cateFragment;
    ShopFragment shopFragment;
    FindFragment findFragment;
    BaketFragment baketFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(R.id.mainLayout, shopFragment, "shop").commit();
    }
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.tv_cate:
                transaction.replace(R.id.mainLayout, shopFragment, "shop");
                break;
            case R.id.tv_find:
                ...
                break;
            case R.id.tv_barket:
                transaction.replace(R.id.mainLayout, baketFragment, "barket");
