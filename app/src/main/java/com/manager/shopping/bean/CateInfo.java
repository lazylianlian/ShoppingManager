...
public class CateInfo implements Serializable {
    ...
    public static class ResultBean implements Serializable{
        ...
        private List<CateDetailInfo> data;
        ...
        public List<CateDetailInfo> getData() {
            return data;
        }

        public void setData(List<CateDetailInfo> data) {
            this.data = data;
        }

        public static class CateDetailInfo implements Serializable{
            private String id;
            ...
            private List<CateStepsInfo> steps;
            ...
            public List<CateStepsInfo> getSteps() {
                return steps;
            }

            public void setSteps(List<CateStepsInfo> steps) {
                this.steps = steps;
            }

            public static class CateStepsInfo implements Serializable{
                private String img;
                private String step;
